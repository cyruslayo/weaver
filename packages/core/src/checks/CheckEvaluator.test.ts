...
test("tree evaluation preserves traversal and independent nested scopes", () => {
  ...
  group.relationships = [{ kind: "template", property: "members", collectionPath: "members", children: [member0, member1] }];
  const root = instance("root");
  root.relationships = [{ kind: "template", property: "groups", collectionPath: "/groups", children: [group] }];
